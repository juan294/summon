...
/**
 * Pad a string to at least `targetWidth` display columns using trailing spaces.
 * Wide characters (CJK, emoji) are counted as 2 columns each.
 */
function displayPadEnd(str: string, targetWidth: number): string {

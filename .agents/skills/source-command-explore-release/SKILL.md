---
name: "source-command-explore-release"
description: "Migrated source command `explore-release`"
---

# source-command-explore-release

Use this skill when the user asks to run the migrated source command `explore-release`.
